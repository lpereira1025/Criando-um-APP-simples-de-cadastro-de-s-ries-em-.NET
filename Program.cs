...
namespace DIO.Series
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			Console.WriteLine("****** FLIX ****** Obrigado por utilizar nossos serviços !");
			Console.ReadLine();
        }
        ...
        private static void ExcluirSerie()
		{
            ...
            Console.WriteLine("****** FLIX ****** Você escolheu: Excluir série");
        ...
        private static void ListarSeries()
		{
            ...
            Console.WriteLine("****** FLIX ****** Você escolheu: Listar todas as séries");

			var lista = repositorio.Lista();

			if (lista.Count == 0)
			{
				Console.WriteLine("****** FLIX ****** Nenhuma série cadastrada.");
				return;
			}
        ...
        private static string ObterOpcaoUsuario()
		{
            Console.WriteLine();
            Console.WriteLine("****************************************************************");
			Console.WriteLine("****** FLIX ****** Estamos a seu dispor ****** FLIX ******");
            Console.WriteLine("****************************************************************");
            Console.WriteLine();
			...
			Console.WriteLine();
            Console.WriteLine("****** FLIX ****** Informe o item desejado:");
